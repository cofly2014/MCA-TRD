...
def parse_command_line():
    ...
    parser.add_argument("--target_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48"], default="ucf", help="Dataset to use.")

    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_ucf101-1/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path",  "-m", default="./checkpoint_ucf101-1/", help="Path to model to load and test.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=10500, help="Path to model to load and test.")
    ...
    args.scratch = "./"
    #
    args.scratch_data = "/data2/mydata/video-mini-frames/"
