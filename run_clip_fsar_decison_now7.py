...
from models.base.cross_domain_fsar_resnet_multi7 import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_diving48_7/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_diving48_7/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=11000, help="Path to model to resume.")
