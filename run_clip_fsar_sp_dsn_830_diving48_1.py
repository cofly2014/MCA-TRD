...
def parse_command_line():
    ...
    parser.add_argument("--source_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48"], default="diving48", help="Dataset to use.")
    parser.add_argument("--target_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48"], default="kinetics", help="Dataset to use.")

    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_diving48-1/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path",  "-m", default="./checkpoint_diving48-1/", help="Path to model to load and test.")
    ...
    parser.add_argument('--class_num', type=int, default=48, help='the number of class catetories in the training stage')
    parser.add_argument('--momentum', type=int, default=0.5, help='momentum coeff')
    parser.add_argument("--trd_lambdas", type=int, default=[1,1,0], help="temporal_set")  # 1是监督分类loss 2是蒸馏loss
