...
class DSN_TEMPORAL(nn.Module):
    ...
    def forward(self, source_domain_features, target_domain_features, support_num, support_labels, iteration=1):  # 获得support support labels, query, support real class
        ...
        #####################################################################################################################
        #target_domain_features_mean_s = self.recalibration_centor(target_domain_shared_enc)
        ...
        source_domain_shared_enc =  self.trans_target(target_domain_features_mean_s, source_domain_shared_enc, source_domain_shared_enc) + target_domain_features_mean_s
        #######################################################################################################################
