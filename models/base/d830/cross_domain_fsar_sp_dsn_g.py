...
from models.base.d830.temporal_model_compat_g import DSN_TEMPORAL
...
class DSN_CROSS_FSAR(nn.Module):
    ...
    def forward(self, inputs, iteration=1):  # 获得support support labels, query, support real class
        ...
        t_result = self.temporal_dsn_net(source_domain_features, target_domain_features, support_num , support_labels)
