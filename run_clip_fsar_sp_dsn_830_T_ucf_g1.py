...
from models.base.d830.cross_domain_fsar_sp_dsn_g import DSN_CROSS_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_ucf_g1/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path",  "-m", default="./checkpoint_diving48_g1/", help="Path to model to load and test.")
