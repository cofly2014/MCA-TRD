...
from models.base.cross_domain_fsar_resnet_multi5 import CROSS_DOMAIN_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_diving48_5/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_diving48_5/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=10000, help="Path to model to resume.")
    parser.add_argument("--resume_from_checkpoint", "-r", dest="resume_from_checkpoint", default=0, action="store_true", help="Restart from latest checkpoint.")

    parser.add_argument("--test_checkpoint_iter", type=int, default=9500, help="Path to model to load and test.")
