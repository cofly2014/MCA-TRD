...
def parse_command_line():
    ...
    parser.add_argument("--resume_checkpoint_iter", type=int, default=8500, help="Path to model to resume.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=20500, help="Path to model to load and test.")
