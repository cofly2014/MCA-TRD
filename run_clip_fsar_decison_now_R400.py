...
def parse_command_line():
    ...
    # 经常需要修改
    parser.add_argument("--training_iterations", "-i", type=int, default=52020, help="Number of meta-training iterations.")
    # 经常需要修改
    ...
    parser.add_argument("--source_dataset", choices=["ssv2", "ssv2_cmn", "kinetics", "hmdb", "ucf", "diving48","rareAct"], default="kinetics_400", help="Dataset to use.")
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_rareAction_400/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path", "-m", default="./checkpoint_rareAction_400/", help="Path to model to load and test.")

    parser.add_argument("--resume_checkpoint_iter", type=int, default=500, help="Path to model to resume.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=27500, help="Path to model to load and test.")  #13000
    ...
    parser.add_argument('--class_num', type=int, default=256, help='the number of class catetories in the training stage')
    ...
    if args.source_dataset == "kinetics":
        ...
        args.trainlist = os.path.join(args.scratch, "splits/kinetics_400_CMN")
        args.scratch_data = "/data1/mydata/video-origin-frames/kinetics400-frames/"
        args.path = os.path.join(args.scratch_data, "train_256/")
    #############################################################################################
    #############################################################################################
