...
def parse_command_line():
    ...
    # 可能需要修改
    parser.add_argument("--save_freq", type=int, default=250, help="Number of iterations between checkpoint saves.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=15750, help="Path to model to load and test.")
    ...
    if args.target_dataset == "ssv2":
        ...
        args.scratch_data = "self.text_features_meta_trainS/video-mini-frames/"
        ...
        args.target_path = os.path.join(args.scratch_data, "diving48-frames/")
