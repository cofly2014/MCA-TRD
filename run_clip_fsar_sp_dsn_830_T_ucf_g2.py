...
import video_reader_cross_res_centor as video_reader
import random
import logging

from models.base.d830.cross_domain_fsar_sp_dsn_gg import DSN_CROSS_FSAR
...
def parse_command_line():
    ...
    parser.add_argument("--checkpoint_dir", "-c", default="./checkpoint_ucf_g2/", help="Directory to save checkpoint to.")
    parser.add_argument("--test_model_path",  "-m", default="./checkpoint_ucf_g2/", help="Path to model to load and test.")
    ...
    parser.add_argument("--test_checkpoint_iter", type=int, default=22000, help="Path to model to load and test.")
    ...
    parser.add_argument('--momentum', type=int, default=0.1,  help='momentum coeff')
